...
/*
// add new element in position with loop
let newElement = 32, position = 3, i = data.length - 1;
console.log(data);
...
// add new element in array with array method
data.splice(1, 0, 222222);
console.log(data);
*/

/*
// remove element from the position in array with loop
console.log(data);
let position = 3,
  index = position;
...
// remove element from the position with array method.
data.splice(position, 1);
console.log(data);
*/

/*
// search element's index in array with loop
console.log(data);
let element = 12,
  index = -1;
...
// search element's index with array method
